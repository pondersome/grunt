...
def generate_launch_description():
    ...
    # 1) Be sure icp_odometry is started
    # first launch separately using 
    # ros2 launch grunt_bringup rtabmap.icp.odom.launch.py
    # instead of below, to keep terminal output separated
    # Node(
