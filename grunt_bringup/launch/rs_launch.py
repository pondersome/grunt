...
configurable_parameters = [{'name': 'camera_name',                  'default': 'cam_live', 'description': 'camera unique name'},
                           ...
                           {'name': 'base_frame_id',                'default': 'link', 'description': 'Root frame of the realsense transform tree - appended to camera_name to form e.g. cam_live_link, which must match the URDF frame'},
